...
export default class PoliceStationLogin extends Component {
    ...
    render() {
        return (
            <div>
                <div className="div">
                    <Navbar portal = "-ADD POLICE STATIONS-" topic1 = "POLICE STATIONS" topic2 = "DASHBOARD"/>
                </div>
                ...
                <form action="#" className="form-body-rules" onSubmit={this.handlerSubmit}>
                    <div className="row">
                        <div className="col">
                            <div className="form-group form-part" >
                                ...
                                <input placeholder= "ENTER REGISTRATION NUMBER" type="text" onChange={this.handlerChange} value={this.state.registrationNo} name="registrationNo" className="form-control form-input-border"/>
                            </div>
                        </div>
                        <div className="col">
                            <div className="form-group form-part">
                                <label htmlFor="station_grade">GRADE</label>
                                <select name="station_grader" id="station_grade" className="form-control form-input-border"name ="3" placeholder="SELECT GRADE">
                    ...
                    <div className="form-group pt-1 form-part" >
                        ...
                        <input type="text" className="form-control form-input-border" placeholder= "ENTER POLICE STATION ADDRESS"  name = "workstation_Address" onChange={this.handlerChange} id="workstation_Address" value={this.state.workstation_Address} />
                    </div>


                    <div className="form-group pt-1 form-part" >
                        <label htmlFor="username">EMAIL</label>
                        <input type="text" className="form-control form-input-border" placeholder= "ENTER OFFICE ADDRESS" name ="email" onChange={this.handlerChange} value={this.state.email}/>
                    </div>
                    ...
                    <div className="row">
                        <div className="col">
                            <div className="form-group form-part" >
                                ...
                                <input type="text" onChange={this.handlerChange} value={this.state.office_Number} placeholder= "ENTER OFFICE TELEPHONE"  name="office_Number" className="form-control form-input-border"/>
                            </div>
                        </div>
                        <div className="col">
                            <div className="form-group form-part" >
                                <label htmlFor="Mobile">HOTLINE</label>
                                <input type="text" placeholder="ENTER HOTLINE" name= "mobile_Number" onChange={this.handlerChange} value={this.state.mobile_Number} className="form-control form-input-border"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col">
                            <div className="form-group form-part" >
                                ...
                                <input type="password"placeholder="ENTER PASSWORD" name="password" onChange={this.handlerChange} value={this.state.password} className="form-control form-input-border"/>
                            </div>
                        </div>
                        <div className="col">
                            <div className="form-group form-part" >
                                <label htmlFor="Mobile">RE-ENTER PASSWORD</label>
                                <input type="password" placeholder="ENTER PASSWORD AGAIN" onChange={this.handlerChange} name="rPassword" value={this.state.rPassword} className="form-control form-input-border"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="buttonHolder text-ligh pt-5">
                        <button className="my-button text-center" value="Submit" title="I'm Feeling Lucky" name="lucky" type="submit"
                                id="btn_i text-light"><b></b></button>
                    </div>
